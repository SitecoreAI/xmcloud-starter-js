...
import { ImageCarouselSieHero } from './ImageCarouselSieHero.dev';
...
export const SieHero: React.FC<ImageCarouselProps> = (props) => {
  const { isEditing } = props.page.mode;

  return <ImageCarouselSieHero {...props} isPageEditing={isEditing} />;
};
