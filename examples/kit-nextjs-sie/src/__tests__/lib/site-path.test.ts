...
describe('buildSiteDataPath', () => {
  ...
  it('uses the live utilities collection by default', () => {
    ...
    expect(buildSiteDataPath('kit-nextjs-sie', '/Data/AI Config/Summary')).toBe(
      '/sitecore/content/utilities/kit-nextjs-sie/Data/AI Config/Summary',
    );
  });
  ...
  it('uses and trims an explicitly configured collection name', () => {
    ...
    expect(buildSiteDataPath('kit-nextjs-sie', '/Data/AI Config/FAQ')).toBe(
      '/sitecore/content/Utility Sites/kit-nextjs-sie/Data/AI Config/FAQ',
    );
  });
});
