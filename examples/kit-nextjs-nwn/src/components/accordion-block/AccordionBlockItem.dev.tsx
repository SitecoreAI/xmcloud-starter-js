...
export const AccordionBlockItem = ({
  ...
  <>
    ...
    >
      <AccordionTrigger className="font-heading flex w-full justify-between py-4 text-left text-lg font-medium">
        {child?.heading?.jsonValue && (
          <Text
            field={child.heading.jsonValue}
            className="font-heading text-left text-lg font-medium"
          />
        )}
      </AccordionTrigger>
      <AccordionContent>
        <div className="font-body py-4 pt-2 text-base font-normal">
