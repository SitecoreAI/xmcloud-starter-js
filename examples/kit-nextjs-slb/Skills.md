# Skills: SLB XM Cloud rendering host

## Purpose

This file provides a capability view for the **kit-nextjs-slb** app. Use it with the repository skills map to choose the right patterns for energy-industry content, article layouts, bilingual routing, and editor-safe components.
...
- **Focus:** SLB brand presentation, modular content, article layouts, and localization (`en` and `es-MX`).
