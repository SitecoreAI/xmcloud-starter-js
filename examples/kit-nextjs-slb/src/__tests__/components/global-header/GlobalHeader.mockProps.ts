...
export const mockAboutUsLink: LinkField = {
  value: {
    href: '/about-us',
    text: 'Who we are',
    title: 'Who we are',
...
export const mockFieldsWithAboutLink = {
  data: {
    item: {
      logo: {
        jsonValue: mockLogo,
      ...
      children: {
        results: [
          { link: { jsonValue: mockNavLink1 } },
          { link: { jsonValue: mockNavLink2 } },
          { link: { jsonValue: mockAboutUsLink } },
        ],
      },
      headerContact: {
        jsonValue: mockHeaderContact,
...
export const propsWithAboutLink: GlobalHeaderProps = {
  params: {
    RenderingIdentifier: 'header-rendering-id',
  },
  fields: mockFieldsWithAboutLink as GlobalHeaderProps['fields'],
  rendering: {
    componentName: 'GlobalHeader',
  } as GlobalHeaderProps['rendering'],
  page: mockPageBase,
