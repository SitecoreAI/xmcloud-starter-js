...
describe('MediaSection Component', () => {
  beforeEach(() => {
    ...
    mockUseSitecore.mockReturnValue(
      mockSitecoreContext as ReturnType<typeof useSitecore>,
    );
    mockUseIntersectionObserver.mockReturnValue([
      true,
      { current: null } as unknown as React.RefObject<HTMLDivElement | null>,
    ]);
  ...
  describe('Video-only rendering', () => {
    ...
    it('should render video with correct classes', () => {
      ...
      const video = container.querySelector('video');
      expect(video?.className).toContain('rounded-none');
  ...
  describe('Image-only rendering', () => {
    ...
    it('should apply correct classes to image', () => {
      ...
      const imageWrapper = screen.getByTestId('image-wrapper');
      expect(imageWrapper.className).toContain('rounded-none');
  ...
  describe('Custom classes', () => {
    ...
    it('should keep custom sizing on the wrapper and square media inside it', () => {
      const { container } = render(<MediaSection {...propsWithCustomClass} />);
    ...
    it('should combine default and custom classes on image', () => {
      ...
      const wrapper = screen.getByTestId('image-wrapper').parentElement;
      const imageWrapper = screen.getByTestId('image-wrapper');
