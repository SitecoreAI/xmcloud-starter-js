...
describe('RichTextBlock Component', () => {
  ...
  it('supports the raw Page Builder CSSStyles parameter', () => {
    render(
      <RichTextBlock
        fields={mockFields}
        params={{ CSSStyles: 'legal-article-body' }}
        rendering={mockRendering}
        page={mockPageBase}
      />,
    );
  ...
  it('does not apply article typography unless the rendering opts in', () => {
    render(
      <RichTextBlock
        fields={mockFields}
        params={{}}
    ...
    render(
      <RichTextBlock
        {...({
          ...
          rendering: mockRendering,
          page: mockPageBase,
        } as unknown as React.ComponentProps<typeof RichTextBlock>)}
      />,
    );
