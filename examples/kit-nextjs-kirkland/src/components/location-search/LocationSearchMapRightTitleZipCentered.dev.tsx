...
export const LocationSearchMapRightTitleZipCentered = (
          ...
          {googleMapsApiKey === '' && isPageEditing && (
            ...
            >
              <p className="border-default bg-secondary text-secondary-foreground max-w-3/4 absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 transform p-4 text-center text-xl">
                Please set the Google Maps API key in the environment variables
                to enable the map.
              </p>
            </AnimatedSection>
          )}
            ...
            >
              ...
              >
                ...
                <Button
                  ...
                  className="font-body flex p-0 text-lg font-medium underline decoration-current underline-offset-2 transition-all duration-200 hover:decoration-transparent group-data-[component=LocationSearch]:py-0"
                  disabled={geoLoading}
                >
                  {!geoLoading ? (
                    <>
          ...
          >
            ...
            >
              <div className="max-h-[500px] space-y-6 overflow-y-auto pr-2">
                {isLoading ? (
                  <div className="py-4 text-center">Loading offices...</div>
                ) : dealerships.length === 0 ? (
                  <div className="py-4 text-center">No offices found</div>
                ) : (
  ...
  return (
    <NoDataFallback componentName="LocationSearchMapRightTitleZipCentered" />
  );
};
