  ...
  if (fields) {
    ...
    const reviewSchemas =
      children?.results?.map((item) =>
        generateReviewSchema(
          item.testimonialAttribution?.jsonValue?.value?.toString() ||
            'Anonymous',
    ...
    return (
      <>
        ...
        <section
          className={cn(
            '@container component testimonial-carousel text-secondary-foreground @md:px-6 @lg:px-0 overflow-hidden rounded-default',
