    ...
    return (
      ...
      >
        <div className="@container/textbanner">
          <div className="legal-content-shell @lg/textbanner:grid @lg/textbanner:grid-cols-2 @lg/textbanner:grid-rows-1 @lg/textbanner:gap-12 py-16 @md/textbanner:py-20">
            {/* Title */}
            <AnimatedSection
              direction="left"
              distanceInRem={12}
